function LogoEmblem({ className = '' }) {
  ...
  return (
    ...
    >
      ...
      <circle cx="26" cy="26" r="19" stroke={g} strokeWidth="1" strokeOpacity="0.4" />
      ...
      <path d="M17 20h4M31 20h4M26 17v-2" stroke={g} strokeWidth="1.5" strokeLinecap="round" strokeOpacity="0.6" />
    </svg>
  )
}
